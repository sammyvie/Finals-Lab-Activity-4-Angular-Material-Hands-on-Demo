...
export class RegisterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formdata = new FormGroup({
      ...
      // Requirement: Starts with letter, Alphanumeric, min 8 chars
      ...
      // Additional Component 1: Select

      status: new FormControl('', Validators.required),

      gender: new FormControl('male'),

      // Additional Component 2: Datepicker + Year Validation

      birthDate: new FormControl('', [Validators.required, this.dateYearValidator]),

      // Additional Component 3: Slider
  ...
  // Requirement: Toggle for Light/Dark Mode
